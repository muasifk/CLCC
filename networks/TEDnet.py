...
class TEDnet(nn.Module):
    '''
    Crowd Counting and Density Estimation by Trellis Encoder-Decoder Networks, CVPR2019
    Source:  https://github.com/hellowangqian/sganet-crowd-counting/blob/master/model_tednet.py
    '''
    def __init__(self, gray_input=False, use_bn=True):
        ...
        self.relu = nn.ReLU()
        # initialize_weights(self.modules()) # original
