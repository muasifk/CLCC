...
'''
Map-style dataset:
When the dataLoader returns a batch from the “map-style” dataset, it is sampling a set of indices and retrieving them with map_dataset[idx]

Iterable-style dataset:
The DataLoader is calling next(iterable_dataset) until it has built a full batch.

'''

class CrowdDataset(Dataset):
    '''
    Iterable-style datasets (use class "IterableDataset")
    ...
    '''
    def __init__(self, img_paths, gt_paths, img_downsample, gt_downsample, ds_name, sigma, augmentation):
    ...
    def __getitem__(self,index):
        ...
        return img_tensor, gt_tensor, count
